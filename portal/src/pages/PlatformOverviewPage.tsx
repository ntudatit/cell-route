...
export function PlatformOverviewPage() {
 ...
 const [tab,setTab]=useState('all'); const [filter,setFilter]=useState('');
 ...
 const rows=services.filter(s=>(tab==='all'||favorites.includes(s.to))&&s.title.toLowerCase().includes(filter.toLowerCase()));
