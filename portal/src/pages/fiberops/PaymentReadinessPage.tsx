...
export function PaymentReadinessPage() {
 ...
 async function analyze() { setLoading(true); setError(""); try { setResult(await fiberOpsApi.readiness(invoice.trim())); } catch(e){ setError(fiberErrorMessage(e)); } finally{setLoading(false);} }
